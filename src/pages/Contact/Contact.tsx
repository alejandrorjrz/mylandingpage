...
function Contact() {
  ...
  return (
    <div className="flex flex-col h-screen bg-slate-700">
      <Header />
      <div className="flex-grow mx-5 flex justify-center text-white font-montserrat">
        <form
          ref={form}
          onSubmit={sendEmail}
        ...
        >
          <h1 className="w-3/4 mx-auto my-10 text-center">
            Gracias por visitar mi página web. Puede enviarme un mensaje a
            través del siguiente formulario:
          </h1>
          <div className="flex gap-5 flex-col font-montserrat md:p-10 md:grid md:grid-rows-1 md:grid-cols-2">
            ...
            <div className="px-1 grid gap-2 justify-items-stretch text-white">
              ...
              <textarea
                name="message"
                className="text-slate-800 rounded md:mt-2"
                rows={5}
                required
              ></textarea>
            </div>
