...
function App() {
  ...
  return (
    <div id="AppPrincipal" className="h-full w-screen bg-gradient-to-r from-slate-800 to-red-900 dark:text-red-600">
      ...
      <div className="flex flex-col items-center md:flex-row md:w-3/4 md:m-auto">
        ...
        <div className="mx-6 md:my-10">
          ...
          <div className="float-right">
            <p className="max-w-4xl mt-10 font-inconsolata text-right text-3xl text-white">Desarrollador Web</p>
